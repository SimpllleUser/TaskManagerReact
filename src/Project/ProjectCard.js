...
<div className="project_card card p-2"  >
  ...
  <div className="card-body">
    ...
    <div className="actions">
      ...
      <Modal title="Edit project" forElement={"edit-project"+id} component={<ProjectForm title={title} description={description} id={id}/>} />
      <button className="btn btn-warning" data-toggle="modal" data-target={"#edit-project"+id}>Edit</button>
